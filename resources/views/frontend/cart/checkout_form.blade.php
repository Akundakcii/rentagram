            ...
            <main class="mt-5">
                <form method="POST" action="{{url("/satin-al")}}">
                    ...
                    <div class="form-group mt-2">
                        <x-input label="Ad Soyad" placeholder="Kart üzerindeki ad soyad" field="name" type="text"/>
                    </div>

                    <div class="form-group mt-2">
                        <x-input label="Kart No" placeholder="16 haneli kart numaranızı giriniz" field="card_no" type="text"/>
                    </div>
