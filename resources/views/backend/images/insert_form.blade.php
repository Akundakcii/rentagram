...
@section("content")
    <form action="{{url("/cars/$car->car_id/images")}}" method="POST" autocomplete="off" novalidate
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="mt-2">
                    <x-input label="Açıklama" placeholder="Kısa açıklama girinizi" field="alt" type="text"/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6">
                <div class="mt-2">
                    <x-input label="Sıra No" placeholder="Sıra no giriniz" field="seq" type="text "/>
                </div>
            </div>
            <div class="col-lg-6">
